...
namespace EjemploMVCCursosOnline.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descripcion,FechaPublicacion")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Descripcion,FechaPublicacion")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var curso = await _context.Curso.Include(c => c.Precio)
                                            .Include(c => c.CursoInstructor)
                                            .FirstOrDefaultAsync(m => m.Id == id);
